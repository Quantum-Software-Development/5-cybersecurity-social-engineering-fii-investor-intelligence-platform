...
5. [What This Platform Delivers](#-what-this-platform-delivers)
6. [Why This Matters](#-why-this-matters)
7. [Architecture and Pipeline](#-architecture-and-pipeline)
8. [Executive Notebook Summary](#-executive-notebook-summary)
9. [Notebooks NB00–NB07: Technical Report](#-notebooks-nb00nb07-technical-report)
10. [The 3 Core Techniques + FAISS Semantic Layer](#-the-3-core-techniques--faiss-semantic-layer-mapreduce--tf-idf--bm25--embeddings)
11. [Data Sources — 21 Sources](#-data-sources--21-monitored-sources)
12. [Big Data Infrastructure](#-big-data-infrastructure)
13. [Dependencies and requirements.txt](#-dependencies-and-requirementstxt)
14. [CRISP-DM Methodology](#-crisp-dm-methodology)
15. [Marketing Funnel: TOFU, MOFU, and BOFU in the Project](#-marketing-funnel-tofu-mofu-and-bofu-in-the-project)
16. [RAG Chatbot: Groq + Gemini (Automatic Fallback)](#-rag-chatbot-groq--gemini-automatic-fallback)
17. [Governance](#-governance)
18. [Folder Structure](#-folder-structure)
19. [Full Documentation (docs/)](#-full-documentation-docs)
20. [How to Run](#-how-to-run)
21. [Automated Testing](#-automated-testing)
22. [Deployment & Automation Workflow](#deployment--automation-workflow)
23. [Which requirements*.txt to Use in Each Scenario](#-which-requirementstxt-to-use-in-each-scenario)
24. [Makefile — Full Reference](#-makefile--full-reference)
25. [Expected Outputs](#-expected-outputs)
26. [Technical Glossary](#-technical-glossary)
27. [Project Repository and Links](#-project-repository-and-links)
